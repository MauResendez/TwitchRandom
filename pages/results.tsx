...
import { Box, CircularProgress, Container, Grid, ImageList, ImageListItem, ImageListItemBar, Pagination } from '@mui/material';
            ...
            {results.length != 0 && !loading &&
                <Container sx={{ pt: '1rem', pb: '3rem' }}>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mt: 5 }}>
                        <Pagination count={pageCount} page={pageNumber} onChange={(e, value) => { setPageNumber(value); }} />
                    </Box>
                </Container>
            }
        </Grid>
